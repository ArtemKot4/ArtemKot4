...
*   **TypeScript, React:** Пишу веб-приложения и инструменты.
*   **Создание языков:** Проектирую и реализую небольшие предметно-ориентированные языки.**.
*   **Плагины и модификации:** Пишу расширения для **VS Code** и моды для **Minecraft** (Java, Inner Core).
...
<img src="https://github.com/ArtemKot4/Ling/blob/main/logo.svg" title="ling" width="40" height="40"/>&nbsp; 
